...
class LAESimulacionApi
{
    ...
    public function getLAEByFolioConsulta($x_api_key, $request = null)
    {
        list($response) = $this->getLAEByFolioConsultaWithHttpInfo($x_api_key, $request);
        return $response;
    }
    ...
    public function getLAEByFolioConsultaAsync($x_api_key, $request = null)
    {
        return $this->getLAEByFolioConsultaAsyncWithHttpInfo($x_api_key, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getLAEByFolioConsultaRequest($x_api_key, $request = null)
    {
    ...
    public function getLAEByPerson($x_api_key, $request = null)
    {
        list($response) = $this->getLAEByPersonWithHttpInfo($x_api_key, $request);
        return $response;
    }
    ...
    public function getLAEByPersonAsync($x_api_key, $request = null)
    {
        return $this->getLAEByPersonAsyncWithHttpInfo($x_api_key, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getLAEByPersonRequest($x_api_key, $request = null)
    {
        if ($x_api_key === null || (is_array($x_api_key) && count($x_api_key) === 0)) {
            throw new \InvalidArgumentException(
